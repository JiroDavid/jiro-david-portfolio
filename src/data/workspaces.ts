...
export const workspaces: Record<WorkspaceId, WorkspaceTheme> = {
  ...
  projects: {
    ...
    windows: [
      { id: 'clip',     title: 'clip_editor.py',  xFrac: 0.060, yFrac: 0.065, wFrac: 0.240, hFrac: 0.67 },
      { id: 'story',    title: 'storyboarder.py', xFrac: 0.310, yFrac: 0.065, wFrac: 0.240, hFrac: 0.67 },
      { id: 'birthday', title: 'birthday.js',     xFrac: 0.560, yFrac: 0.065, wFrac: 0.240, hFrac: 0.67 },
      { id: 'terminal', title: 'terminal.sh',     xFrac: 0.810, yFrac: 0.065, wFrac: 0.175, hFrac: 0.67 },
    ],
  },
