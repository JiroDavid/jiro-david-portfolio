...
export const workspaces: Record<WorkspaceId, WorkspaceTheme> = {
  ...
  projects: {
    ...
    windows: [
      { id: 'clip',     title: 'clip_editor.py',  xFrac: 0.020, yFrac: 0.065, wFrac: 0.195, hFrac: 0.67 },
      { id: 'story',    title: 'storyboarder.py', xFrac: 0.225, yFrac: 0.065, wFrac: 0.195, hFrac: 0.67 },
      { id: 'birthday', title: 'birthday.js',     xFrac: 0.430, yFrac: 0.065, wFrac: 0.195, hFrac: 0.67 },
      { id: 'shima',    title: 'shima_tts.py',    xFrac: 0.635, yFrac: 0.065, wFrac: 0.195, hFrac: 0.67 },
